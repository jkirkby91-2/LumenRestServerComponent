<?php
	...
	namespace Jkirkby91\LumenRestServerComponent\Http\Controllers {
		...
		use Jkirkby91\{
			Boilers\RestServerBoiler\ResourceControllerContract, LumenRestServerComponent\Libraries\ResourceResponseTrait, LumenRestServerComponent\Http\Controllers\RestController, Boilers\RestServerBoiler\Exceptions\NotFoundHttpException, Boilers\RestServerBoiler\Exceptions\UnauthorizedHttpException, Boilers\RestServerBoiler\TransformerContract as ObjectTransformer, Boilers\RepositoryBoiler\ResourceRepositoryContract as ResourceRepository
		};
		...
		abstract class ResourceController extends RestController implements ResourceControllerContract
		{
			 ...
			 * @return \Zend\Diactoros\Response\JsonResponse
			 */
			public function show(ServerRequestInterface $request, int $id) : \Zend\Diactoros\Response\JsonResponse
			{
			 ...
			 * @return \Zend\Diactoros\Response\JsonResponse
			 */
			public function destroy(ServerRequestInterface $request, int $id) : \Zend\Diactoros\Response\JsonResponse
			{
				if(!$data = $this->repository->find($id))
				{
					throw new NotFoundHttpException;
